...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-24 11:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ee05f48d-f696-4a67-a694-642346ccb2c5.git
$ cd ee05f48d-f696-4a67-a694-642346ccb2c5
```
